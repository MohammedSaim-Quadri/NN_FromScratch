...
'''
Lets add regularization logic to our already existing code.
UPDATED:
- Added L1 and L2 regularization to the class Layer __init__ method
- Added L1 and L2 regularization to the class Layer backward method
- Added new regularization_loss method to the common Loss class
'''
class Layer_Dense:
...
'''
epoch: 10000, acc: 0.919, loss: 0.257 (data_loss: 0.209, reg_loss: 0.048), lr: 0.019900507413187767
Training finished...
Validation started...
validation, acc: 0.887, loss: 0.239
Validation finished...
'''